...
export default function HomePage({ isDark, toggleDark }) {
  ...
  const serviceUrl =
    "https://secure-earth-39442.herokuapp.com/https://www.metaweather.com";
  ...
  const fetchWeather = (woeid) => {
    ...
    axios
      .get(`${serviceUrl}/api/location/${woeid}`, {
        headers: {
          Origin: "https://adatta93.github.io",
        },
      })
      .then(
        (res) => {
  ...
  const searchLocation = () => {
    setLoading(true);
    axios
      .get(`${serviceUrl}/api/location/search/?query=${query}`, {
        headers: {
          Origin: "https://adatta93.github.io",
        },
      })
